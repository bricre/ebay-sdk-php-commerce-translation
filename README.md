# (Unofficial) eBay API client (PHP) - Commerce / Translation
...
Starting from version v1_beta.1.4, this project will match according eBay API's versioning. Should you found a matching 
